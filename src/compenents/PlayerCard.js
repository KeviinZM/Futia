...
export default function PlayerCard({ player }) {
  return (
    <div className="relative group w-64 h-80 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border-2 border-slate-700 shadow-xl overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-purple-500/50 hover:border-purple-500">
      ...
      <div className="absolute top-4 left-4 z-10 text-white">
        ...
        <div className="mt-2 space-y-1">
             {/* Drapeaux et Clubs (cercles simples pour l'instant) */}
      ...
      <div className="absolute bottom-0 w-full bg-slate-950/80 p-3 backdrop-blur-sm border-t border-slate-700">
        ...
        {/* Notre touche spéciale : Le Score Meta */}
